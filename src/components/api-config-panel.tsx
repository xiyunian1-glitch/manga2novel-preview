        ...
        <div className="rounded-xl border bg-muted/10 p-3.5">
          <div className="grid gap-3 xl:grid-cols-[minmax(0,18rem)_minmax(0,1fr)_auto] xl:items-start">
            ...
            <div className="flex flex-wrap items-center gap-2 xl:justify-end">
              <Button type="button" size="sm" onClick={() => handleEditorOpenChange(true)} disabled={disabled}>
                配置 API
              </Button>
            </div>
          </div>
            ...
            <div className="max-h-[80vh] overflow-y-auto pr-1">
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3 border-t pt-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button type="button" size="sm" variant="outline" onClick={() => handleEditorOpenChange(false)}>
                      取消
                    </Button>
                    <Button
                      type="button"
